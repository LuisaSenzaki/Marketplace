...
<body>
    <div class="header-html">
        <div class="header">
            ...
            <div class="search">
                ...
                <section class="search-filters">
                    ...
                    <section class="social">
                        <a href="https://www.instagram.com/xlabexperience/"> 
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#9F9F9F" class="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <div class="options">
                <div class="calc">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#D0147A" class="bi bi-calculator-fill" viewBox="0 0 16 16" cursor="pointer">
                ...
                <div class="admin">
                    <a href="{{ route('admin') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#D0147A" class="bi bi-person-fill" viewBox="0 0 16 16" cursor="pointer">
