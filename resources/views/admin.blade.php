...
<div class="options-page"> 
    <div class="add-produto">
        ...
        <button style="cursor: pointer;">Novo Produto 
    ...
    <div class="formulario-container-add">
        ...
        @csrf
            <div class="infos-principais-add">
                <!-- Uploader reutilizável -->
                <div class="image-uploader" style="cursor: pointer; text-align: center;">
                    ...
                    <img class="preview-image" src="" alt="Preview da imagem" style="width: 100%; height: 350px; display: none; border-radius: 8px; margin-top: 10px; text-align: center;">
                </div>          
                ...
                <div class="first-container-add">
                    ...
                    <div class="texto-info-edit">
                        ...
                        <textarea name="description" class="description-hub-edit" placeholder="Adicione a descrição da Tecnologia..." style="color: #9F9F9F; background: #fff; box-shadow: 4px 4px 4px 0 rgba(0, 0, 0, 0.05); border-radius: 10px; min-height: 230px; padding: 10px; font-family: 'gilroy-light';"></textarea>
                    </div>
                </div>
            </div>
        ...
        @foreach($products as $product)
            <li class="produto-infos"> 
                <div class="left-side-infos">
                    <div class="img-product-adm">
                        <img class="perfil-img" src="{{ asset('storage/'.$product->image) }}" alt="{{ $product->name }}"> </div>
    ...
    <ul class="produtos-totais">
        @foreach($hubProducts as $hub)
            <li class="produto-infos">
                <div class="left-side-infos">
                    <div class="img-product-adm">
                        <img class="perfil-img" src="{{ asset('storage/'.$hub->image) }}" alt="{{ $hub->name }}" style="object-fit: cover;"> </div>
                    <div class="produto-texto">
                        <p>{{ $hub->name }}</p>
                        <p>{{ $hub->modalidade }}</p>
...
<!-- Script para Imagem Principal (funciona em múltiplas áreas) -->
<script>
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.image-uploader').forEach(function (uploader) {
        const trigger = uploader.querySelector('.upload-content');
